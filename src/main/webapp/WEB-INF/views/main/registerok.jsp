        ...
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-11 ftco-animate text-center">
             ...
             <div style="border-radius: 50px; height: 500px; width: 1000px; margin: 0 auto; background-color: white">
                ...
                <div style="padding: 50px; font-size: 2.5rem;">가족이 되신 것을 환영합니다!</div>
                <div style="width: 500px; margin: 0 auto; padding: 50px; display: flex; justify-content: space-between;">
                   <div>
                      <input type="button" value="메인으로" style="width: 150px; height: 50px; border: 0; background-color: #F8A1A4; border-radius: 5px; color: white;" onclick="location.href='/main/index';">
                   </div>
                   <div>
                     <input type="button" value="로그인" style="width: 150px; height: 50px; border: 0; background-color: #F8A1A4; border-radius: 5px; color: white;" onclick="location.href='/petsitter/page';">
                  </div>
                </div>
             </div>
