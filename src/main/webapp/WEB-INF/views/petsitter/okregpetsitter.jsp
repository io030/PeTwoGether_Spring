        ...
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-11 ftco-animate text-center">
             ...
             <div style="border-radius: 50px; height: 500px; width: 1000px; margin: 0 auto; background-color: white">
                ...
                <div style="padding: 50px; font-size: 2.5rem;">펫 시터 등록이 완료되었습니다!</div>
                <div style="width: 500px; margin: 0 auto; padding: 50px; display: flex; justify-content: space-between;">
                   ...
                   <div>
                     <input type="button" value="마이페이지" style="width: 150px; height: 50px; border: 0; background-color: #F8A1A4; border-radius: 5px; color: white;" onclick="location.href='/petwogether/petsitter/pmypage';">
                  </div>
                </div>
             </div>
